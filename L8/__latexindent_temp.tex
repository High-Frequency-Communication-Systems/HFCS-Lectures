\documentclass[10pt]{beamer}
    ...
    \begin{filecontents*}{refs.bib}
        ...
        year = {2021},
        keywords = {antenna, Antenna arrays, Antenna measurements, Antennas, Bandwidth, Coplanar waveguides, Fabrication, gold, PICA, Substrates, terahertz},
        pages = {1--1}
    }
    ...
    @article{ma_millimeter-wave_2019,
        ...
        volume = {18},
        issn = {1548-5757},
        doi = {10.1109/LAWP.2019.2910657},
        number = {6},
        journal = {IEEE Antennas and Wireless Propagation Letters},
        author = {Ma, Chaojun and Ma, Zu-Hui and Zhang, Xiupu},
        month = jun,
        year = {2019},
        keywords = {Antenna array, Antenna arrays, Antenna feeds, Bandwidth, circularly polarized (CP), Gain, Impedance, millimeter-wave (MMW), substrate integrated gap waveguide (SIGW)},
        pages = {1124--1128}
    }
    \end{filecontents*}
