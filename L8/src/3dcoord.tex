...
\draw[thick,-latex,color=blue] (r1) -- (r2) node[anchor=east]{$\va{r}$};
\draw[thick,-latex,color=blue] (Q2xy) -- (P2xy) node[anchor=north]{$\va{H}$};
\draw[thick,-latex,color=blue] (E1) -- (E2) node[anchor=north]{$\va{E}$};

\draw[-latex,very thick, color=green!20!black] (0,0,\h - \l/2) --  node[anchor=north east]{} (0,0,\h + \l/2) node[midway, color = black, anchor= south east]{$I \dd{l}$};
