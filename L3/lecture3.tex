...
\end{array}\right.
  ...
  \begin{figure}
  \centering
  \includegraphics[width=.3\textwidth]{line_source.pdf}
\end{figure}
\end{frame}
...
\begin{align*}
  \va{E} &= - \j \O \va{A} - (- \j \O \va{A} \cdot \vu{r})\vu{r} \\
...
\begin{frame}
  ...
  \end{align*}
  For freespace, the value is $\eta_0 = 376.7 \Omega \approx 120 \pi \Omega$
\end{frame}
...
\begin{frame}
  ...
  \begin{outline}
    ...
    \1 Directivity id defined as the ratio of radiation intensity in a certain direction to the average radiation intensity
  \end{outline}
  \begin{align*}
