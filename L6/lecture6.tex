...
\begin{frame}
    \frametitle{The Finite Difference Negotiation}
    \begin{columns}[T] % align columns
        \begin{column}{.6\textwidth}
...
ez[i] = ez[m] + (hy[i] - hy[i - 1]) * imp0 / epsR[i]
    \end{minted}
...
\begin{frame}
    ...
    Chapter 3 - Understanding the FDTD Method \footcite{schneider_understanding_nodate}
