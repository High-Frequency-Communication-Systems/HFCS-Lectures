...
\begin{tikzpicture}
    ...
    \begin{smithchart}[
        ...
        -- (1,0) coordinate (b)
        -- (0,-0.69) coordinate (c)
        pic[draw=black, "$\beta l$",  ->, solid, angle eccentricity=1.4, angle radius=1cm,text=black]
            {angle=a--b--c};


        \addplot [black,mark=*,only marks,point meta=explicit symbolic,nodes near coords,text=black] coordinates {
                (0.4,0.7) [$z_{L}$]
            };
