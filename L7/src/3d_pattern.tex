...
\tdplotsetmaincoords{70}{135}
    \begin{tikzpicture}[scale=2,line join=bevel,tdplot_main_coords, fill opacity=.9]
        ...
        {\draw[color=black,thick,->] (0,0,0) -- (2,0,0) node[anchor=north east]{$z$};}%
        {\draw[color=black,thick,->] (0,0,0) -- (0,2,0) node[anchor=north west]{$x$};}%
        {\draw[color=black,thick,->] (0,0,0) -- (0,0,1) node[anchor=south]{$y$};}
    \end{tikzpicture}
% \begin{figure}[]
% \begin{center}
%         \begin{tikzpicture}
