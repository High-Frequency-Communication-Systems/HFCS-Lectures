...
\begin{frame}
    ...
    \begin{figure}[h!]
        ...
        \caption{EM wave attenuation and free-space pathloss due to \ch{H2O} molecules in the air in the THz spectrum \tiny{[Nagatsuma, T., \textit{et al}. Nature Photon 10, 371–379 (2016)]}.}
    \end{figure}
\end{frame}
